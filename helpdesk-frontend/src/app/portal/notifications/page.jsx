...
function ticketHref(notification) {
  return notification?.ticketId ? `/portal/tickets/${notification.ticketId}` : '/portal/my-tickets';
}
      ...
      <div className="mb-6 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="mt-1 text-xs text-slate-500">
            Replies from agents and status updates on your tickets.
          </p>
        </div>
        <Button
          variant="outline"
      ...
      {notifications.length === 0 ? (
        <Card className="py-16 text-center">
          ...
          <p className="mt-1 text-xs text-slate-400">
            Agent replies and ticket status updates will appear here.
          </p>
        </Card>
      ) : (
